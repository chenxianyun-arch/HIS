          ...
          <div class="select-box">
            ...
            <div class="table">
              ...
              >
                ...
                <el-table-column prop="jiesuanDoctor" label="医生姓名" width="150">
                  <template slot-scope="scope">
                    <el-popover trigger="hover" placement="top">
                      <p>用户名: {{ scope.row.jiesuanDoctor }}</p>
                      <p>电话: {{ scope.row.jiesuanDoctor }}</p>
                ...
                <el-table-column width="150" prop="jiesuanCard" label="银行卡号">
                </el-table-column>
                <el-table-column width="150" prop="jiesuanState" label="=结算状态">
                </el-table-column>
                <el-table-column width="200" prop="refundState" label="收入来源">
                  <template slot-scope="scope">
                    <div
                      style="
                        display: flex;
                ...
                <el-table-column width="100" prop="jiesuanDate" label="交易时间">
                </el-table-column>
              </el-table>
            </div>
          </div>
