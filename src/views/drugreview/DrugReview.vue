          ...
          <div class="select-box">
            ...
            <div class="table">
              ...
              >
                ...
                <el-table-column prop="shenheName" label="药品名称" width="150">
                  <template slot-scope="scope">
                    <el-popover trigger="hover" placement="top">
                      <p>用户名: {{ scope.row.shenheName }}</p>
                      <p>电话: {{ scope.row.shenheName }}</p>
                      <div slot="reference" class="name-wrapper">
                        <el-tag size="medium">{{
                          scope.row.shenheName
                        }}</el-tag>
                      </div>
                    </el-popover>
                  </template>
                ...
                <el-table-column width="150" prop="shenhePrice" label="价格">
                </el-table-column>
                <el-table-column width="150" prop="shenheState" label="状态">
                </el-table-column>
                <el-table-column
                  width="150s"
                ...
                <el-table-column width="150s" prop="shenheKucun" label="库存">
                </el-table-column>
                <el-table-column
                  width="150s"
                  prop="shenheTime"
                ...
                <el-table-column width="150" prop="refundState" label="操作">
                  <template slot-scope="scope">
                    <div
                      style="
                        display: flex;
