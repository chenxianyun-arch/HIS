...
jiaoyiSource: "挂号预约"
jiaoyiState: "成功"
jiaoyiTime: "2021-03-18T15:42:14.000+00:00"
jiaoyiUsername: "18882d3454"-->
                <el-table-column type="selection" width="55"> </el-table-column>
                <el-table-column prop="jiaoyiNumber" label="交易流水号" width="100">
                  <template slot-scope="scope">
                    <el-popover trigger="hover" placement="top">
                      <p>用户名: {{ scope.row.jiaoyiNumber }}</p>
                      <p>电话: {{ scope.row.jiaoyiNumber }}</p>
                      <div slot="reference" class="name-wrapper">
                        <el-tag size="medium">{{ scope.row.jiaoyiNumber }}</el-tag>
                      </div>
                    </el-popover>
                  </template>
                </el-table-column>
                <el-table-column width="120" prop="jiaoyiUsername" label="用户">
                </el-table-column>
                <el-table-column width="120" prop="jiaoyiPrice" label="交易金额">
                </el-table-column>
                <el-table-column width="130" prop="jiaoyiSource" label="来源">
                </el-table-column>
                <el-table-column width="130" prop="jiaoyiPayway" label="支付方式">
                </el-table-column>
                <el-table-column width="130" prop="jiaoyiState" label="交易状态">
                </el-table-column>
                <el-table-column width="130" prop="jiaoyiTime" label="交易时间">
                </el-table-column>
              </el-table>
            </div>
          </div>
  ...
  methods: {
    ...
    handleSelectionChange(val) {
      ...
      for (let index = 0; index < val.length; index++) {
        selectId.push(val[index].jiaoyiId);
      }
      // 3 将循环得到得Id值进行赋值
