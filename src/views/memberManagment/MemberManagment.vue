          ...
          <div class="select-box">
            ...
            <div class="table">
              ...
              >
                ...
                <el-table-column prop="admin" label="用户名" width="150">
                  <template slot-scope="scope">
                    <el-popover trigger="hover" placement="top">
                      <p>用户名: {{ scope.row.memberName }}</p>
                      <p>电话: {{ scope.row.memberName }}</p>
                ...
                <el-table-column width="150" prop="memberPhone" label="手机号">
                </el-table-column>
                <el-table-column width="150" prop="memberRole" label="角色">
                </el-table-column>
                <el-table-column
                  width="150s"
                  prop="memberTime"
