                ...
                >
                  <template slot-scope="scope">
                    <el-popover trigger="hover" placement="top">
                      <p>用户名: {{ scope.row.suggestionType }}</p>
                      <p>电话: {{ scope.row.suggestionType }}</p>
                      <div slot="reference" class="name-wrapper">
                        <el-tag size="medium">{{
                          scope.row.suggestionType
                        }}</el-tag>
                      </div>
                    </el-popover>
                    <!-- 
                          suggestionCommit: "18812341234"
                          suggestionContent: "希望产品体验更人性化一些"
                          suggestionDelete: 1
                          suggestionId: 133
                          suggestionTime: "2021-03-23"
                          suggestionType: "产品体验" -->
                  </template>
                </el-table-column>
                <el-table-column
