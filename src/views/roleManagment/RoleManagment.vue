          ...
          <div class="select-box">
            ...
            <div class="table">
              ...
              >
                ...
                <el-table-column prop="roleName" label="角色名" width="150">
                  <template slot-scope="scope">
                    <el-popover trigger="hover" placement="top">
                      <p>用户名: {{ scope.row.roleName }}</p>
                      <p>电话: {{ scope.row.roleName }}</p>
                ...
                <el-table-column width="150" prop="roleState" label="启用状态">
                </el-table-column>

                <el-table-column width="150" prop="roleTime" label="添加时间">
                </el-table-column>
