          ...
          <div class="select-box">
            ...
            <div class="table">
              ...
              >
                ...
                <el-table-column prop="wenzhenId" label="订单编号" width="100">
                  <template slot-scope="scope">
                    <el-popover trigger="hover" placement="top">
                      <p>用户名: {{ scope.row.wenzhenId }}</p>
                      <p>电话: {{ scope.row.wenzhenId }}</p>
                      <div slot="reference" class="name-wrapper">
                        <el-tag size="medium">{{ scope.row.wenzhenId }}</el-tag>
                      </div>
                    </el-popover>
                  </template>
                </el-table-column>
                <el-table-column width="120" prop="wenzhenTime" label="提交时间">
                </el-table-column>
                <el-table-column width="120" prop="wenzhenUsername" label="用户名">
                </el-table-column>
                <el-table-column width="130" prop="wenzhenDoctor" label="医生">
                </el-table-column>
                <el-table-column width="130" prop="wenzhenKeshi" label="科室">
                </el-table-column>
                <el-table-column width="130" prop="wenzhenPrice" label="挂号费">
                </el-table-column>
                <el-table-column width="130" prop="wenzhenState" label="订单状态">
                </el-table-column>
                  ...
                  <template slot-scope="scope">
                    ...
                    >
                      ...
                      <el-button
                        type="text"
                        size="medium"
                        @click="deletSingalClick(scope.row.wenzhenId)"
                      >删除</el-button
                      >
                    </div>
                  </template>
