          ...
          <div class="select-box">
            ...
            <div class="table">
              ...
              >
                ...
                <el-table-column prop="medecineName" label="药品名称" width="160">
                  <template slot-scope="scope">
                    <el-popover trigger="hover" placement="top">
                      <p>用户名: {{ scope.row.medecineName }}</p>
                      <p>电话: {{ scope.row.medecineName }}</p>
                ...
                <el-table-column width="150" prop="medecinePrice" label="价格">
                </el-table-column>
                <el-table-column width="150" prop="medecineShangjia" label="上架">
                  <template slot-scope="scope">
                    <el-switch
                      style="display: block"
                      v-model="scope.row.medecineShangjia"
                      active-color="#13ce66"
                      active-text="审核"
                      inactive-text="关闭"
                  ...
                  <template slot-scope="scope">
                    ...
                    >
                      ...
                      <el-button
                        type="text"
                        size="medium"
                        @click="deletSingalClick(scope.row)"
                      >删除</el-button
                      >
                    </div>
                  </template>
