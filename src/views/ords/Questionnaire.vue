          ...
          <div class="select-box">
            ...
            <div class="table">
              ...
              >
                ...
                <el-table-column prop="questionnaireTime" label="提交问诊时间" width="100">
                  <template slot-scope="scope">
                    <el-popover trigger="hover" placement="top">
                      <p>用户名: {{ scope.row.questionnaireTime }}</p>
                      <p>电话: {{ scope.row.questionnaireTime }}</p>
                      <div slot="reference" class="name-wrapper">
                        <el-tag size="medium">{{ scope.row.questionnaireTime }}</el-tag>
                      </div>
                    </el-popover>
                  </template>
                </el-table-column>
                <el-table-column width="120" prop="questionnairePatient" label="患者">
                </el-table-column>
                <el-table-column width="120" prop="questionnaireKeshi" label="科室">
                </el-table-column>
                <el-table-column width="130" prop="questionnaireDoctor" label="医生">
                </el-table-column>
                <el-table-column width="130" prop="questionnaireWay" label="方式">
                </el-table-column>
                <el-table-column width="130" prop="questionnaireSource" label="来源">
                </el-table-column>
                <el-table-column width="130" prop="questionnaireCost" label="问诊费">
                </el-table-column>
                <el-table-column width="100" prop="questionnaireState" label="订单状态">
                </el-table-column>
