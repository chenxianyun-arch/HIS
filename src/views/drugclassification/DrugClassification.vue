          ...
          <div class="select-box">
            ...
            <div class="table">
              ...
              >
                ...
                <el-table-column prop="yaopinName" label="分类名称" width="150">
                  <template slot-scope="scope">
                    <el-popover trigger="hover" placement="top">
                      <p>用户名: {{ scope.row.yaopinName }}</p>
                      <p>电话: {{ scope.row.yaopinName }}</p>
                ...
                <el-table-column width="150" prop="yaopinState" label="状态">
                </el-table-column>
                <el-table-column width="150" prop="yaopinBeizhu" label="=备注">
                </el-table-column>
                <el-table-column width="150s" prop="yaopinDate" label="添加时间">
                </el-table-column>
                <el-table-column width="400" prop="refundState" label="操作">
                  <template slot-scope="scope">
                    <div
                      style="
                        display: flex;
