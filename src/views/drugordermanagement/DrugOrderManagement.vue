          ...
          <div class="select-box">
            ...
            <div class="table">
              ...
              >
                ...
                <el-table-column prop="orderId" label="订单编号" width="100">
                  <template slot-scope="scope">
                    <el-popover trigger="hover" placement="top">
                      <p>用户名: {{ scope.row.orderId }}</p>
                      <p>电话: {{ scope.row.orderId }}</p>
                ...
                <el-table-column width="120" prop="orderTime" label="提交时间">
                </el-table-column>
                <el-table-column width="120" prop="orderUsername" label="用户名">
                </el-table-column>
                <el-table-column width="130" prop="orderGetname" label="收货人">
                </el-table-column>
                <el-table-column width="130" prop="orderPrice" label="订单金额">
                </el-table-column>
